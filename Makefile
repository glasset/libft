...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2013/11/19 16:31:00 by glasset           #+#    #+#              #
#    Updated: 2013/11/29 17:28:59 by glasset          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a

SRC  = ./ft_atoi.c ./ft_bzero.c ./ft_memccpy.c ./ft_memchr.c ./ft_memcmp.c \
	   ./ft_memcpy.c ./ft_memmove.c ./ft_memset.c ./ft_putchar.c \
	   ./ft_putendl.c ./ft_putnbr.c ./ft_putstr.c ./ft_strcat.c ./ft_strchr.c \
	   ./ft_strcmp.c ./ft_strcpy.c ./ft_strdup.c ./ft_strlcat.c ./ft_strlen.c \
	   ./ft_strncat.c ./ft_strncmp.c ./ft_strncpy.c ./ft_strnstr.c \
	   ./ft_strrchr.c ./ft_strstr.c ./ft_isalpha.c ./ft_isdigit.c \
